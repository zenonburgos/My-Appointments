  ...
  <div class="card-body">
    ...
    <form action="{{ url('appointments') }}" method="post">
      ...
      <div class="form-group">
        ...
        <input name="description" value="{{ old('description') }}" id="description" type="text" class="form-control" placeholder="Describa brevemente la consulta" required>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="input-group">
            ...
            <input class="form-control datepicker" placeholder="Seleccione fecha" 
